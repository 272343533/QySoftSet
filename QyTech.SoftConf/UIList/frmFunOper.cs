...
namespace QyTech.SoftConf.UIList
{
    public partial class frmFunOper : qyfLayoutListWithLeft
    {
        ...
        public frmFunOper():base(GlobalVaribles.EM_Base, GlobalVaribles.EM_Base, GlobalVaribles.SqConn_Base, Guid.Parse("4C1E9407-618A-4A3F-86AB-07279F64B095"), "bsFC_Id in (select bsFC_Id from bsFunConf where bsN_Id in (select bsN_Id from bsNavigation where bsA_Id='" + GlobalVaribles.currAppObj.AppId.ToString()+"'))", "SortCode")
        {
            InitializeComponent();
