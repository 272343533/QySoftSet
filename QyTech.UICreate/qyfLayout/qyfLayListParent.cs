...
{
    public partial class qyfLayListParent : Form
    {
        ...
        protected object currLeftFPk;
        protected string currLeftText;
        ...
        /// <summary>
        public qyfLayListParent(ObjectContext db_Base, ObjectContext db_App, SqlConnection conn, 
        ...
        public void RefreshDgv(qyDgv dgv,string where, string orderby = "")
        {
            try
            {
                ...
                string strWhere = strBaseWhere;//这个条件再左树结构中用作左侧树的规律条件了
                if (where != "")
                {
                    //if (strWhere != "")
                    //    strWhere += " and " + where;
                ...
                dtList = dgvList.DataSource as DataTable;
        ...
        protected virtual string CreateWhere()
        {
            string Conditions = "";
        ...
        private void CreateQueryGroupBox()
        {
            ...
            {
                //参数未实体对象
                List<bsFunQuery> fqs = EntityManager_Static.GetListNoPaging<bsFunQuery>(DB_Base, "bsFC_Id='" + bsFc.bsFC_Id.ToString() + "' and itempos='上部'", "");
                int gbWidth =0;
        ...
        protected ToolStripButton AddtsbButton(string text)
        {
            ToolStripButton tsb = new ToolStripButton();
            //tsb.Image = ((System.Drawing.Image)(resources.GetObject("tsbSetQueryField.Image")));
            tsb.ImageTransparentColor = System.Drawing.Color.Magenta;
            tsb.Name = "tsb"+text;
            tsb.Size = new System.Drawing.Size(76, 22);
            tsb.Text = text;
            tsbToolBar.Items.Add(tsb);
            return tsb;
        }
        #endregion
    }
