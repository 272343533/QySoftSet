...
{
    public partial class qyfListWithLeft : qyFormWithTitle
    {
        ...
        public qyfListWithLeft(EntityManager em_Base, EntityManager em_App, SqlConnection conn, string tname, string where = "", string orderby = "")
        {
            InitializeComponent();
            EM_Base = em_Base;
            EM_App = em_App;
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            qyfAdd frmaddobj = new qyfAdd(AddOrEdit.Add, userobj, EM_App);
