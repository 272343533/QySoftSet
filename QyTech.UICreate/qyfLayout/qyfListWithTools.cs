...
{
    public partial class qyfListWithTools : qyFormWithTitle
    {
        ...
        public qyfListWithTools(EntityManager em_Base, EntityManager em_App,SqlConnection conn,string tname,string where="",string orderby="")
        {
            InitializeComponent();
        ...
        {
            qyfAdd frmaddobj = new qyfAdd(AddOrEdit.Add, CurrRowObj, EM_App);
        ...
        private void tsbEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                GetCurrObj();
                qyfAdd frmaddobj = new qyfAdd(AddOrEdit.Edit, CurrRowObj, EM_App);
                frmaddobj.ShowDialog();
            }
            catch (Exception ex)
            {
