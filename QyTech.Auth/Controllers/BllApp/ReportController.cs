...
namespace QyExpress.Controllers.BllApp
{
    public class ReportController : BllAppController
    {
        ...
        public string RptLandLtdUpInfo(string sessionid, string kvwhere)
        {
            ...
            List<rptLandLtdUpInfo> lst = EntityManager_Static.GetAllByStorProcedure<rptLandLtdUpInfo>(DbContext, "bllSp_rptLandLtdUpInfo", new object[] { dics["cycle"], dics["flowstatus"], dics["ltdchar"] });
        ...
        public string RptLandLtdUpRent(string sessionid, string kvwhere)
        {
            ...
            Dictionary<string, string> dics = kvWhere2Dic(kvwhere);
            List<rptLandLtdUpRent> lst = EntityManager_Static.GetAllByStorProcedure<rptLandLtdUpRent>(DbContext, "bllSp_rptLandLtdUpRent", new object[] { dics["cycle"], dics["flowstatus"], dics["ltdchar"] });
        ...
        public string RptRentLtdUpInfo(string sessionid, string kvwhere)
        {
            ...
            Dictionary<string, string> dics = kvWhere2Dic(kvwhere);
            List<rptRentLtdUpInfo> lst = EntityManager_Static.GetAllByStorProcedure<rptRentLtdUpInfo>(DbContext, "bllSp_rptRentLtdUpInfo", new object[] { dics["cycle"], dics["flowstatus"], dics["ltdchar"] });
            if (lst.Count > 0)
            {
                Type type = lst[0].GetType();
                return QyTech.Json.JsonHelper.SerializeObject(lst, type, null);
        ...
        public string RptLtdCheck(string sessionid, string kvwhere)
        {
            ...
            if (!dics.ContainsKey("haverelltd"))
                dics["haverelltd"] = "0";
            List<rptLtdCheck> lst = EntityManager_Static.GetAllByStorProcedure<rptLtdCheck>(DbContext, "bllSp_rptLtdCheck", new object[] { dics["checkstatus"], dics["ltdname"],dics["haverelltd"] });
        ...
        public string RptLtdPostition(string sessionid,string kvwhere)
        {
            ...
            Dictionary<string, string> dics = kvWhere2Dic(kvwhere);
            List<rptLtdPostition> lst = EntityManager_Static.GetAllByStorProcedure<rptLtdPostition>(DbContext, "bllSp_rptLtdPostition", new object[] { dics["islandltd"], dics["ltdname"]});
        ...
        public string RptLtdReginfo(string sessionid, string kvwhere)
        {
            ...
            Dictionary<string, string> dics = kvWhere2Dic(kvwhere);
            List<rptLtdRegInfo> lst = EntityManager_Static.GetAllByStorProcedure<rptLtdRegInfo>(DbContext, "bllSp_rptLtdRegInfo", new object[] { dics["islandltd"], dics["ltdname"] });
