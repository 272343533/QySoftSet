    ...
    <div class="tree">
        ...
        <div class="tree-operate">
            <el-button-group v-if="btnEdit">
                <el-button type="primary" size="small" icon="plus"   @click="emitBtnAdd">新增</el-button>
                <el-button type="danger"  size="small" icon="delete" @click="emitBtnDel">删除</el-button>
                <el-button type="primary"  size="small" icon="delete" @click="search">刷新</el-button>
            </el-button-group>
        </div>
...
<script>
    ...
    export default {
        ...
        props: ['url', 'onclick', 'btnEdit', 'default-expand-all','addNode'],
        methods: {
            search(){
                var me = this;
            ...
            emitBtnDel() {
                console.log('delete');
                //此处是否可以直接删除，不需要用户写代码,暂时先用
                this.$emit('emitBtnDel', this.currentNode)
            }
        },
        created: function () {
            this.search()
