<template>
    <div class="layout-tree-grid">
        <el-row :gutter="20">
            <el-col :span="4">
                <tu-tree url='api/bsnavigation/treedis?where=[%7B"key":"NaviName","val":""%7D]' v-on:emitId="clickNode"></tu-tree>
            </el-col>
            <el-col :span="20">
                <div class="condition">
                    <el-form :inline="true" :model="searchForm">
                        ...
                        <el-form-item>
                            <el-input v-model="searchForm.FunName" placeholder="功能名称"></el-input>
                        </el-form-item>
                        <el-form-item>
                ...
                <div class="grid">
                    <el-table :data="gridData" border stripe height="'100%'">                        
                        <el-table-column prop="FunCode" label="功能编号">
                        </el-table-column>
                        <el-table-column prop="FunType" label="功能项分类">
                        </el-table-column>
                        <el-table-column prop="FunName" label="功能名称">
                        </el-table-column>
                        <el-table-column prop="FunUrl" label="功能控制器">
                        </el-table-column>
                        <el-table-column prop="" label="列表对象">
                        </el-table-column>
                        <el-table-column prop="TName" label="编辑表">
                        </el-table-column>
                        <el-table-column prop="TPk" label="对应表主键">
                        </el-table-column>
                        <el-table-column prop="NotNullField" label="非空字段">
                        </el-table-column>
                        <el-table-column prop="" label="查询字段列表">
                        </el-table-column>
                        <el-table-column prop="" label="排序字段">
                        </el-table-column>
                        <el-table-column prop="FilterField" label="过滤字段">
                        </el-table-column>
                        <el-table-column prop="FilterValue" label="过滤值">
                        </el-table-column>
                        <el-table-column prop="ContactTel" label="查找带回">
                        </el-table-column>
                        <el-table-column prop="RegDt" label="查找字段">
                        </el-table-column>
                        <el-table-column prop="" label="所属编号">
                        </el-table-column>
                        <el-table-column prop="PFk" label="对应外键">
                        </el-table-column>
                        <el-table-column prop="Operartor" label="操作人">
                        </el-table-column>
                        <el-table-column prop="UpdateDt" label="更新时间">
                        </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            search() {
                const me = this;
                this.$ajax('get', '/api/bsfunconf/getallwithpaging', {
                    // 改写后端方法
            ...
            removeRow(row) {
                ...
                this.$confirm('是否删除此项数据?', '警告', {
                    ...
                    this.$ajax('post', '/api/bsfunconf/delete', {
                        idValue: row.bsU_Id
                    }, function (res) {
                        me.search();
                    });
            ...
            openDialog(id) {
                ...
                if (id) {
                    // 编辑根据主键请求数据并赋值form
                    console.log(id)
                    this.$ajax('post', '/api/bsfunconf/getone', {
                        idValue: id
                    }, function (res) {
                        console.log(res)
                        me.dialogForm = res;
            ...
            dialogSubmit() {
                var me = this;
                this.$ajax('post', '/api/bsfunconf/add', {
