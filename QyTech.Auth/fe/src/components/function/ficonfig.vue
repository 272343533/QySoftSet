            ...
            <el-col :span="24">               
                ...
                <div class="grid">
                    <el-table :data="gridData" border stripe height="'100%'">
                        ...
                        <el-table-column prop="LoginName" label="描述">
                        </el-table-column>
                        <el-table-column prop="NickName" label="接口类型">
                        </el-table-column>
                        <el-table-column prop="ContactTel" label="返回对象">
                        </el-table-column>
                        <el-table-column prop="RegDt" label="接口名称">
                        </el-table-column>
                        <el-table-column prop="AccountStatus" label="参数">
                        </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            search() {
                const me = this;
                this.$ajax('get', '/api/meixiae/getallwithpaging', {
