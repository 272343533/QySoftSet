            ...
            <el-col :span="24">               
                ...
                <div class="grid">
                    <el-table :data="gridData" border stripe height="'100%'">
                        ...
                        <el-table-column prop="OperName" label="操作名称">
                        </el-table-column>
                        <el-table-column prop="btnClass" label="图标样式">
                        </el-table-column>
                        <el-table-column prop="LinkUrl" label="链接地址">
                        </el-table-column>
                        <el-table-column prop="RegDt" label="target">
                        </el-table-column>
                        <el-table-column prop="AccountStatus" label="rel">
                        </el-table-column>
                        <el-table-column prop="IsOnline" label="窗口高度">
                        </el-table-column>
                        <el-table-column prop="IsSysUser" label="窗口宽度">
                        </el-table-column>
                        <el-table-column prop="LoginDt" label="AjaxTodo提示">
                        </el-table-column>
                        <el-table-column prop="LoginDt" label="可用">
                        </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            search() {
                const me = this;
                this.$ajax('get', '/api/bsFunOper/getallwithpaging', {
                      // 改写后端方法
                    where: JSON.stringify([{
                            key: 'OperName',
                            val: me.searchForm.OperName
                        }]),
