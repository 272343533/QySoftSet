            ...
            <el-col :span="24">
                ...
                <div class="grid">
                    <el-table :data="gridData" border stripe height="'100%'">
                        ...
                        <el-table-column prop="OperName" label="数据项">
                        </el-table-column>
                        <el-table-column prop="FName" label="字段名">
                        </el-table-column>
                        <el-table-column prop="" label="数据类型">
                        </el-table-column>
                        <el-table-column prop="OperType" label="输入方式">
                        </el-table-column>
                        <el-table-column prop="ItemPos" label="位置">
                        </el-table-column>
                        <el-table-column prop="IsOnline" label="链接地址|{固定参数}">
                        </el-table-column>
                        <el-table-column prop="IsSysUser" label="宽度,高度">
                        </el-table-column>
    ...
    export default {
        ...
        methods: {
            search() {
                console.log("123");
                const me = this;
                this.$ajax('get', '/api/bsFunQuery/getallwithpaging', {
                    // 改写后端方法
