            ...
            <el-col :span="24">
                ...
                <div class="grid">
                    <el-table :data="gridData" border stripe height="'100%'">
                        <el-table-column prop="FNo" label="序号">
                        </el-table-column>
                        <el-table-column prop="FName" label="字段名称">
                        </el-table-column>
                        <el-table-column prop="FDesp" label="字段描述">
                        </el-table-column>
                        <el-table-column prop="" label="权限">
                        </el-table-column>
                        <el-table-column prop="FType" label="数据类型">
                        </el-table-column>
                        <el-table-column prop="OType" label="编辑类型">
                        </el-table-column>
                        <el-table-column prop="" label="调用接口|{固定参数}">
                        </el-table-column>
                        <el-table-column prop="DefalutValue" label="默认值">
                        </el-table-column>
                        <el-table-column prop="NoInList" label="列表序号">
                        </el-table-column>
                        <el-table-column prop="VisibleInList" label="可见">
                        </el-table-column>
                        <el-table-column prop="FEditable" label="编辑">
                        </el-table-column>
                        <el-table-column prop="" label="窗体序号">
                        </el-table-column>
                        <el-table-column prop="" label="字符数">
                        </el-table-column>
                        <el-table-column prop="VisibleInForm" label="可见">
                        </el-table-column>
                        <el-table-column prop="LoginDt" label="可编辑">
                        </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            search() {
                const me = this;
                this.$ajax('get', '/api/bsFunField/getallwithpaging', {
                    // 改写后端方法
