    ...
    <div class="layout-table-simple">
        ...
        <div class="toolbar">
            <el-button-group>
                ...
                <el-button type="primary" size="small"><i class="fa fa-edit"></i> 选择删除</el-button>
            </el-button-group>
        </div>
        <div class="grid">
        ...
        <el-dialog :close-on-click-modal="false" :close-on-press-escape="false" title="新增用户" v-model="dialogVisible" size="tiny">
            <el-form :model="dialogForm">
                ...
                <el-form-item label="用户状态：" :label-width="'120px'">
                    <el-switch v-model="dialogForm.AccountStatus" on-text="正常" off-text="禁用">
                    </el-switch>
                </el-form-item>
            ...
            dialogSubmit() {
                ...
                this.$ajax('post', '/api/bsuser/add', {
                    strJson: JSON.stringify({
                        ...
                        AccountStatus: me.dialogForm.AccountStatus == true ? '正常' : '禁用',
